...
<div class="layout-4">
	...
	<?php } 
			...
			?>
				...
				if($data->js_config['type']=='custom-grid')
				{ ?>
					<div class="col-md-<?php echo $data->settings['select_column']; ?> project col-sm-6 col-12">
						<div style="margin: <?php echo $data->settings['gutter'] ?>px;">
				...
				<?php } ?>
					...
					<div class="dimmer">
						<div class="overlay" style="background-color: <?php echo $data->settings['contentBg'] ?>; ">

							<?php if($image['link'] != '') { ?>

							<a href="<?php echo $image['link']; ?>" <?php if($image['target'] == '1') { ?> target="_blank" <?php } ?> class="link" title="">

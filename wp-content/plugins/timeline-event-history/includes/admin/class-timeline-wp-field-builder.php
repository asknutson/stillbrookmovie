	...
	private function _render_settings_metabox() {
		...
		foreach ( $tabs as $tab_id => $tab ) {
			...
			if ( isset( $tab['title'] ) || isset( $tab['description'] ) ) {
				...
				$current_tab_content .= '<a href="https://wp-timeline-wp.com/docs/" target="_blank" class="">' . esc_html__( 'Documentation', timeline_wp ) . '</a>';
				$current_tab_content .= '<span> - or - </span>';
				$current_tab_content .= '<a href="https://wp-timeline-wp.com/contact-us/" target="_blank" class="">' . esc_html__( 'Get in touch', timeline_wp ) . '</a>';
				$current_tab_content .= '</div>';

...
?>
<div id="my-accordion-<?php echo $PostId; ?>" class="accordion-slider accordion-slider-<?php echo $PostId; ?>" style="margin-bottom: 100px;">
        <div class="as-panels">
            <?php
...
<script type="text/javascript">
    jQuery(document).ready(function($) {
        $( '.accordion-slider-<?php echo $PostId; ?>' ).each(function( index ) { 
            var slider_id   = $(this).attr('id');  
            var slider_conf = $.parseJSON( $(this).closest('#my-accordion-<?php echo $PostId; ?>').find('.wpaas-conf-<?php echo $PostId; ?>').text());
                
            if( typeof(slider_id) != 'undefined' && slider_id != '' ) { 
                $('#my-accordion-<?php echo $PostId; ?>').WPaccordionSlider({

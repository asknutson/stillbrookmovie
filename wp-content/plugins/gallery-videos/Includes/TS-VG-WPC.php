...
if($Total_Soft_GalleryV_Type[0]->TotalSoftGalleryV_SetType=='Parallax Engine'){ ?>
  <script type="text/javascript">
    ...
    (function(t, e, i) {
      ...
      function w() {
        ...
        }), d(t(n))) : _.get("iframe") ? d(" ") : _.get("html") ? d(_.get("html")) : a(_, n) ? (n=l(_, n), U=e.createElement("img"), t(U).addClass(Z + "Photo<?php echo $Total_Soft_Gallery_Video;?>").bind("error", function() {
      ...
      var v, x, y, b, T, C, H, k, E, W, L, S, M, R, F, I, K, P, B, O, _, D, j, A, N, z, U, $, q, G, Q, J, V, X={
      ...
      }, Y="colorbox<?php echo $Total_Soft_Gallery_Video;?>", Z="cbox", te=Z + "Element<?php echo $Total_Soft_Gallery_Video;?>", ee=Z + "_open", ie=Z + "_load", oe=Z + "_complete", ne=Z + "_cleanup", re=Z + "_closed", he=Z + "_purge", se=t("<a/>"), ae="div", le=0, de={}, ce=function() {
        function t() {
          clearTimeout(h)
        }
        ...
        var r, h, s=Z + "Slideshow<?php echo $Total_Soft_Gallery_Video;?>_", a="click." + Z;
        return function() {
          r ? _.get("slideshow") || (se.unbind(ne, n), n()) : _.get("slideshow") && E[1] && (r= !0, se.one(ne, n), _.get("slideshowAuto") ? i() : o(), I.show())
        }
      }();
      t.colorbox<?php echo $Total_Soft_Gallery_Video;?>|| (t(p), J=t.fn[Y]=t[Y]=function(e, i) {
        var o, n=this;
        ...
        if(W.unbind("resize." + Z), x.css({top: -9e4, left: -9e4}), h=W.scrollTop(), a=W.scrollLeft(), _.get("fixed") ? (c.top-=h, c.left-=a, x.css({position: "fixed"})) : (l=h, d=a, x.css({position: "fixed"})), d+=_.get("right")!== !1 ? Math.max(W.width() - _.w - N - j - s(_.get("right"), "x"), 0) : _.get("left")!== !1 ? s(_.get("left"), "x") : Math.round(Math.max(W.width() - _.w - N - j, 0) / 2), l+=_.get("bottom")!== !1 ? Math.max(n() - _.h - A - D - s(_.get("bottom"), "y"), 0) : _.get("top")!== !1 ? s(_.get("top"), "y") : Math.round(Math.max(n() - _.h - A - D, 0) / 2), x.css({top: c.top, left: c.left, visibility: "visible"}), y[0].style.width=y[0].style.height="9999px", r={width: _.w + N + j, height: _.h + A + D>150? Math.round(jQuery(window).width()*0.7/16*9):0, top:(jQuery(window).height() - Math.round(jQuery(window).width()*0.7/16*9))/2, left: d}, e) {
          var g=0;
          t.each(r, function(t) {
        ...
        if($) {
          ...
          L.remove(), L=o(ae, "LoadedContent<?php echo $Total_Soft_Gallery_Video;?>").append(i), L.hide().appendTo(S.show()).css({width: '100%', position: 'relative', overflow: _.get("scrolling") ? "auto" : "hidden"}).css({height: '100%'}).prependTo(b), S.hide(), t(U).css({"float": "none"}), c(_.get("className")), d=function() {
            function i() {
            ...
            })) : O.hide(), _.get("iframe") ? (o=e.createElement("iframe"), "frameBorder" in o && (o.frameBorder=0), "allowTransparency" in o && (o.allowTransparency="true"), _.get("scrolling") || (o.scrolling="no"), t(o).attr({src: _.get("href"), name: (new Date).getTime(), "class": Z + "Iframe<?php echo $Total_Soft_Gallery_Video;?>", allowFullScreen: !0}).one("load", n).appendTo(L), se.one(he, function() {
              o.src="//about:blank"
        ...
        x && (x.stop(), t.colorbox<?php echo $Total_Soft_Gallery_Video;?>.close(), x.stop().remove(), v.remove(), G= !1, x=null, t("." + te).removeData(Y).removeClass(te), t(e).unbind("click." + Z))
      }, J.element=function() {
        return t(_.el)
      }, J.settings=X)
      ...
      $.swipebox<?php echo $Total_Soft_Gallery_Video;?>=function(elem, options) {
        ...
        var ui={
          init: function(index) {
            ...
            this.target.trigger("swipebox<?php echo $Total_Soft_Gallery_Video;?>-start");
            $.swipebox<?php echo $Total_Soft_Gallery_Video;?>.isOpen=true;
            this.build();
            ...
            $("body").append(html);
            if($this.doCssTrans()) {
              $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-slider").css({"-webkit-transition": "left 0.4s ease", "-moz-transition": "left 0.4s ease", "-o-transition": "left 0.4s ease", "-khtml-transition": "left 0.4s ease", transition: "left 0.4s ease"});
              $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-overlay").css({"-webkit-transition": "opacity 1s ease", "-moz-transition": "opacity 1s ease", "-o-transition": "opacity 1s ease", "-khtml-transition": "opacity 1s ease", transition: "opacity 1s ease"});
              $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-action, #swipebox<?php echo $Total_Soft_Gallery_Video;?>-caption").css({"-webkit-transition": "0.5s", "-moz-transition": "0.5s", "-o-transition": "0.5s", "-khtml-transition": "0.5s", transition: "0.5s"})
            }
            if(supportSVG) {
              var bg=$("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-action #swipebox<?php echo $Total_Soft_Gallery_Video;?>-close").css("background-image");
              bg=bg.replace("png", "svg");
              $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-action #swipebox<?php echo $Total_Soft_Gallery_Video;?>-prev,#swipebox<?php echo $Total_Soft_Gallery_Video;?>-action #swipebox<?php echo $Total_Soft_Gallery_Video;?>-next,#swipebox<?php echo $Total_Soft_Gallery_Video;?>-action #swipebox<?php echo $Total_Soft_Gallery_Video;?>-close").css({"background-image": bg})
            }
            $.each(elements, function() {
              $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-slider").append('<div class="slide"></div>')
            });
            $this.setDim();
            $this.actions();
            $this.keyboard();
            ...
            $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-overlay").css(sliderCss)
          }, resize: function() {
            var $this=this;
            ...
            if(this.doCssTrans()) {
              ...
              $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-caption").animate({top: 0}, 500);
              $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-action").animate({bottom: 0}, 500);
              setTimeout(function() {
                bars.addClass("visible-bars")
              }, 1e3)
            }
            ...
            if(this.doCssTrans()) {
              ...
              $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-caption").animate({top: "-50px"}, 500);
              $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-action").animate({bottom: "-50px"}, 500);
              setTimeout(function() {
                bars.removeClass("visible-bars")
              }, 1e3)
            }
            ...
            bars.addClass("visible-bars");
            $this.setTimeout();
            $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-slider").click(function(e) {
              if(!bars.hasClass("visible-bars")) {
                $this.showBars();
                $this.setTimeout()
              }
            });
            $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-action").hover(function() {
              $this.showBars();
            ...
            if(elements.length < 2) {
              $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-prev, #swipebox<?php echo $Total_Soft_Gallery_Video;?>-next").hide()
            }
            else {
              $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-prev").bind("click touchend", function(e) {
            ...
            $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-close").bind("click touchend", function(e) {
              $this.closeSlide()
            })
          }, setSlide: function(index, isFirst) {
            isFirst=isFirst || false;
            var slider=$("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-slider");
            if(this.doCssTrans()) {
            ...
            $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-slider .slide").removeClass("current");
            $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-slider .slide").eq(index).addClass("current");
            this.setTitle(index);
            if(isFirst) {
              slider.fadeIn()
            }
            $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-prev, #swipebox<?php echo $Total_Soft_Gallery_Video;?>-next").removeClass("disabled");
            if(index==0) {
              $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-prev").addClass("disabled")
            }
            else if(index==elements.length - 1) {
              $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-next").addClass("disabled")
            }
          }, openSlide: function(index) {
            $("html").addClass("swipebox<?php echo $Total_Soft_Gallery_Video;?>");
            ...
            if(!$this.isVideo(src)) {
              $this.loadMedia(src, function() {
                $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-slider .slide").eq(index).html(this)
              })
            }
            else {
              $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-slider .slide").eq(index).html($this.getVideo(src))
            }
          }, setTitle: function(index, isFirst) {
            var title=null;
            $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-caption").empty();
            if(elements[index]!==undefined) title=elements[index].title;
            if(title) {
              $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-caption").append(title)
            }
			...
			if($(iframe).attr("src")){
				src_url = $(iframe).attr("src");
				if (src_url.indexOf('youtube')>0) url_heigth = Math.round(jQuery(window).width()*0.7/16*9);
			}
            return '<div class="swipebox<?php echo $Total_Soft_Gallery_Video;?>-video-container" style="max-width:' + plugin.settings.videomaxWidth + 'px"><div class="swipebox<?php echo $Total_Soft_Gallery_Video;?>-video"   style="height:' + url_heigth + 'px; ">' + iframe + "</div></div>"
            ...
            var $this=this;
            index=$("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-slider .slide").index($("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-slider .slide.current"));
            if(index + 1 < elements.length) {
              ...
              $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-slider").addClass("rightSpring");
              setTimeout(function() {
                $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-slider").removeClass("rightSpring")
              }, 500)
            }
          }, getPrev: function() {
            index=$("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-slider .slide").index($("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-slider .slide.current"));
            if(index > 0) {
              ...
              $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-slider").addClass("leftSpring");
              setTimeout(function() {
                $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-slider").removeClass("leftSpring")
              }, 500)
            }
          }, closeSlide: function() {
            $("html").removeClass("swipebox<?php echo $Total_Soft_Gallery_Video;?>");
            $(window).trigger("resize");
            this.destroy()
          }, destroy: function() {
            $(window).unbind("keyup");
            ...
            $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-slider").unbind();
            $("#swipebox<?php echo $Total_Soft_Gallery_Video;?>-overlay").remove();
            if(!$.isArray(elem)) elem.removeData("_swipebox<?php echo $Total_Soft_Gallery_Video;?>");
            if(this.target) this.target.trigger("swipebox<?php echo $Total_Soft_Gallery_Video;?>-destroy");
            $.swipebox<?php echo $Total_Soft_Gallery_Video;?>.isOpen=false;
            if(plugin.settings.afterClose) plugin.settings.afterClose()
          }
        };
        plugin.init()
      };
      $.fn.swipebox<?php echo $Total_Soft_Gallery_Video;?>=function(options) {
        if(!$.data(this, "_swipebox<?php echo $Total_Soft_Gallery_Video;?>")) {
          var swipebox<?php echo $Total_Soft_Gallery_Video;?>=new $.swipebox<?php echo $Total_Soft_Gallery_Video;?>(this, options);
          this.data("_swipebox<?php echo $Total_Soft_Gallery_Video;?>", swipebox<?php echo $Total_Soft_Gallery_Video;?>)
        }
        return this.data("_swipebox<?php echo $Total_Soft_Gallery_Video;?>")
      }
  ...
  <style>
      ...
      #cboxWrapper<?php echo $Total_Soft_Gallery_Video;?> {
          max-width: none;
      }

      #cboxOverlay<?php echo $Total_Soft_Gallery_Video;?> {
          position: fixed;
          width: 100%;
          height: 100%;
      }

      #cboxMiddleLeft<?php echo $Total_Soft_Gallery_Video;?>, #cboxBottomLeft<?php echo $Total_Soft_Gallery_Video;?> {
          clear: left;
      }
      ...
      #cboxLoadedContent<?php echo $Total_Soft_Gallery_Video;?> {
          overflow: auto;
      ...
      .cboxPhoto<?php echo $Total_Soft_Gallery_Video;?> {
          float: left;
          margin: auto;
          border: 0;
          display: block;
      ...
      .cboxIframe<?php echo $Total_Soft_Gallery_Video;?> {
          width: 100%;
          height: 100%;
          display: block;
          border: 0;
      ...
      #colorbox<?php echo $Total_Soft_Gallery_Video;?> {
          outline: 0;
      }

      #cboxTopLeft<?php echo $Total_Soft_Gallery_Video;?> {
          width: 0px;
          height: 0px;
          background: #fff;
          display: none;
      ...
      #cboxTopRight<?php echo $Total_Soft_Gallery_Video;?> {
          width: 0px;
          height: 0px;
          background: #fff;
          display: none;
      ...
      #cboxBottomLeft<?php echo $Total_Soft_Gallery_Video;?> {
          width: 0px;
          height: 0px;
          background: #fff;
          display: none;
      ...
      #cboxBottomRight<?php echo $Total_Soft_Gallery_Video;?> {
          width: 0px;
          height: 0px;
          background: #fff;
          display: none;
      ...
      #cboxMiddleLeft<?php echo $Total_Soft_Gallery_Video;?> {
          width: 0px;
          background: #fff;
          display: none;
      }

      #cboxMiddleRight<?php echo $Total_Soft_Gallery_Video;?> {
          width: 0px;
          background: #fff;
          display: none;
      }

      #cboxTopCenter<?php echo $Total_Soft_Gallery_Video;?> {
          height: 0px;
          background: #fff;
          display: none;
      }

      #cboxBottomCenter<?php echo $Total_Soft_Gallery_Video;?> {
          height: 0px;
          background: #fff;
          display: none;
      }
      ...
      #cboxTitle<?php echo $Total_Soft_Gallery_Video;?> {
          position: relative;
          top: <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_32; ?>px;
          left: 0;
          text-align: center;
          width: 100%;
          color: #949494;
      ...
      #cboxPrevious<?php echo $Total_Soft_Gallery_Video;?>:active, #cboxNext<?php echo $Total_Soft_Gallery_Video;?>:active, #cboxSlideshow<?php echo $Total_Soft_Gallery_Video;?>:active, #cboxClose<?php echo $Total_Soft_Gallery_Video;?>:active {
          outline: 0;
      }

      #cboxSlideshow<?php echo $Total_Soft_Gallery_Video;?> {
          position: absolute;
          bottom: 4px;
          right: 30px;
          color: #0092ef;
      ...
      #cboxPrevious<?php echo $Total_Soft_Gallery_Video;?> {
          position: absolute;
          top: calc(100% + <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_32;?>px);
          left: 0;
          font-size: 25px;
          opacity: 0.7;
          color: red;
      ...
      #cboxPrevious<?php echo $Total_Soft_Gallery_Video;?>:hover {
          opacity: 1;
      }

      #cboxNext<?php echo $Total_Soft_Gallery_Video;?> {
          position: absolute;
          top: calc(100% + <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_32;?>px);
          left: 27px;
          font-size: 25px;
      ...
      #cboxNext<?php echo $Total_Soft_Gallery_Video;?>:hover {
          opacity: 1;
      }

      #cboxClose<?php echo $Total_Soft_Gallery_Video;?> {
          position: absolute;
          top: calc(100% + <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_32;?>px);
          right: 0;
          color: red;
      ...
      #cboxClose<?php echo $Total_Soft_Gallery_Video;?>:hover {
          opacity: 1;
      }
      ...
      /*swipebox*/
      html.swipebox<?php echo $Total_Soft_Gallery_Video;?> {
          overflow: hidden !important;
      }

      #swipebox<?php echo $Total_Soft_Gallery_Video;?>-overlay img {
      ...
      #swipebox<?php echo $Total_Soft_Gallery_Video;?>-slider {
          height: 100%;
          left: 0;
          top: 0;
          width: 100%;
      ...
      #swipebox<?php echo $Total_Soft_Gallery_Video;?>-slider .slide:before {
          content: "";
          display: inline-block;
          height: 50%;
          width: 1px;
      ...
      #swipebox<?php echo $Total_Soft_Gallery_Video;?>-action {
          bottom: -50px;
      }

      #swipebox<?php echo $Total_Soft_Gallery_Video;?>-action.visible-bars {
          bottom: 0;
      }

      #swipebox<?php echo $Total_Soft_Gallery_Video;?>-action.force-visible-bars {
          bottom: 0 !important;
      }
      ...
      #swipebox<?php echo $Total_Soft_Gallery_Video;?>-caption.visible-bars {
          top: 0;
      }

      #swipebox<?php echo $Total_Soft_Gallery_Video;?>-caption.force-visible-bars {
          top: 0 !important;
      }
      ...
      #swipebox<?php echo $Total_Soft_Gallery_Video;?>-action #swipebox<?php echo $Total_Soft_Gallery_Video;?>-close {
          background-position: 15px 12px;
          left: 40px;
      }

      #swipebox<?php echo $Total_Soft_Gallery_Video;?>-action #swipebox<?php echo $Total_Soft_Gallery_Video;?>-prev {
          background-position: -32px 13px;
          right: 100px;
      }

      #swipebox<?php echo $Total_Soft_Gallery_Video;?>-action #swipebox<?php echo $Total_Soft_Gallery_Video;?>-next {
      ...
      #swipebox<?php echo $Total_Soft_Gallery_Video;?>-slider.rightSpring {
          animation: rightSpring 0.3s;
          -moz-animation: rightSpring 0.3s;
          -webkit-animation: rightSpring 0.3s;
      }

      #swipebox<?php echo $Total_Soft_Gallery_Video;?>-slider.leftSpring {
      ...
      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?> {
          ...
          opacity: 0;
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_18 == 'moveUp'){ ?> -webkit-transform: translateY(200px);
          -moz-transform: translateY(200px);
          transform: translateY(200px);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_18 == 'scaleUp'){ ?> -webkit-transform: scale(0.6);
          -moz-transform: scale(0.6);
          transform: scale(0.6);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_18 == 'fallPerspective'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform: translateZ(400px) translateY(300px) rotateX(-90deg);
          -moz-transform: translateZ(400px) translateY(300px) rotateX(-90deg);
          transform: translateZ(400px) translateY(300px) rotateX(-90deg);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_18 == 'fly'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
      ...
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_18 == 'flip'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
      ...
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_18 == 'helix'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform: rotateY(-180deg);
          -moz-transform: rotateY(-180deg);
          transform: rotateY(-180deg);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_18 == 'popUp'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
      ...
      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?> img {
          width: 100% !important;
      ...
      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine1 {
          transition: all 0s linear;
          -moz-transition: all 0s linear;
          -webkit-transition: all 0s linear;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine5 {
          transition: all 0s linear;
          -moz-transition: all 0s linear;
          -webkit-transition: all 0s linear;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine6 {
          transition: all 0s linear;
          -moz-transition: all 0s linear;
          -webkit-transition: all 0s linear;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine7 {
          transition: all 0s linear;
          -moz-transition: all 0s linear;
          -webkit-transition: all 0s linear;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine8 {
          transition: all 0s linear;
          -moz-transition: all 0s linear;
          -webkit-transition: all 0s linear;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine9 {
          transition: all 0s linear;
          -moz-transition: all 0s linear;
          -webkit-transition: all 0s linear;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine10 {
          transition: all 0s linear;
          -moz-transition: all 0s linear;
          -webkit-transition: all 0s linear;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine11 {
          transition: all 0s linear;
          -moz-transition: all 0s linear;
          -webkit-transition: all 0s linear;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine2 {
          opacity: 1;
          width: 90%;
          height: 90%;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine3 {
          opacity: 1;
          width: 90%;
          height: 90%;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine4 {
          opacity: 1;
          top: 50%;
          left: 50%;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine6_1 {
          width: 100%;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine6_2 {
          height: 100%;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine6_3 {
          width: 100%;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine6_4 {
          height: 100%;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine8_1 {
          width: 100%;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine8_2 {
          height: 100%;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine8_3 {
          width: 100%;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine8_4 {
          height: 100%;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine9_1 {
          width: 100%;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine9_2 {
          height: 100%;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine9_3 {
          width: 100%;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine9_4 {
          height: 100%;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine12_1 {
          width: 100%;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine12_2 {
          height: 100%;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine12_3 {
          width: 100%;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_HovLine12_4 {
          height: 100%;
      }
      ...
      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_Hov_Overlay1 {
          width: 90% !important;
          height: 90% !important;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_Hov_Overlay3 {
          width: 100% !important;
          height: 100% !important;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_Hov_Overlay4 {
          opacity: 0.8 !important;
      }

      .TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>:hover .TotalSoft_Hov_Overlay5 {
          opacity: 0 !important;
      }

      .line_TotalSoft {
      <?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_20==1 || $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_20=='true') { ?> display: block !important;
      <?php }else{?> display: none !important;
      <?php } ?>
      }

      .Ov_TotalSoft {
      <?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_27==1 || $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_27=='true') { ?> display: block !important;
      <?php }else{?> display: none !important;
      <?php } ?>
      }
      ...
      <?php } ?>
      ul.pagination<?php echo $Total_Soft_Gallery_Video;?> li {
          border: none !important;
      ...
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_09!='none'){ ?> border: 1px <?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_16;?> <?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_17;?> !important;
      <?php } else { ?> border: none !important;
      <?php }?> display: block;
      }
      ...
      .TotalSoftGV_PE_LM<?php echo $Total_Soft_Gallery_Video;?> {
          ...
          font-size: <?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_10;?>px;
          font-family: <?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_11;?>;
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_09!='none'){ ?> border: 1px<?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_16;?> <?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_17;?>;
      <?php } else { ?> border: none !important;
      <?php }?> cursor: pointer;
          display: block;
      ...
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_18 == 'fallPerspective'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_18 == 'fly'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_18 == 'flip'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_18 == 'helix'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_18 == 'popUp'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }?>
      }
  ...
  <div class="TotSoft_GV_Container-parent<?php echo $Total_Soft_Gallery_Video; ?>" style="position: relative; width: 100%; float: left;">
    ...
    <div class="TotSoft_GV_Container TotSoft_GV_Container_<?php echo $Total_Soft_Gallery_Video; ?> myExMul" id="swipeboxVideo_Totsoft">
					<?php for($i=0;$i<count($Total_Soft_GalleryV_Videos);$i ++){ ?>
						<?php if(str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL)==''){
							...
							if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_29==1){
								$str           =str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL);
								$TS_GV_PE_VSR  =str_replace('Tsyou_','https://www.youtube.com/watch?v=',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_Video);
								$TS_GV_PE_VSRST=str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL);
							}
							else{
								$TS_GV_PE_VSR=str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL);
							}
						} ?>
           ...
           <a id="TotalSoft_GV_PE_<?php echo $Total_Soft_Gallery_Video; ?>_<?php echo $i + 1; ?>" class="TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video; ?> <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_07; ?> swipebox<?php echo $Total_Soft_Gallery_Video; ?>-video-TotSoft<?php echo $Total_Soft_Gallery_Video; ?>" href="<?php echo $TS_GV_PE_VSRST; ?>" name="<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>" datah="<?php echo html_entity_decode(str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL)); ?>"> <img class="TotalSoft_HZ2" alt="<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>" src="<?php echo str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL); ?>"/>
             ...
             <div class="<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_26; ?> Ov_TotalSoft"></div>
							...
							<?php }else{ ?>
           <a id="TotalSoft_GV_PE_<?php echo $Total_Soft_Gallery_Video; ?>_<?php echo $i + 1; ?>" class="TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video; ?> <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_07; ?> swipebox<?php echo $Total_Soft_Gallery_Video; ?>-video-TotSoft<?php echo $Total_Soft_Gallery_Video; ?>" href="<?php echo $TS_GV_PE_VSRST; ?>" name="<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>"> <img class="TotalSoft_HZ2" alt="<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>" src="<?php echo str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL); ?>"/> <span style="display:inline-block;" class="TotalSoft_Title_Ef <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_14; ?>">
											<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>
													<?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_15==1||$TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_15=='true'){ ?>
               <br/><i class="<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_16; ?> TotalSoft_PI"></i>
													<?php } ?>
             ...
             <a id="TotalSoft_GV_PE_<?php echo $Total_Soft_Gallery_Video; ?>_<?php echo $i + 1; ?>" class="TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video; ?> <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_07; ?> swipebox<?php echo $Total_Soft_Gallery_Video; ?>-video-TotSoft<?php echo $Total_Soft_Gallery_Video; ?>" href="<?php echo $TS_GV_PE_VSRST; ?>" name="<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>"> <img class="TotalSoft_HZ2" alt="<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>" src="<?php echo str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL); ?>"/> <span style="display:inline-block;" class="TotalSoft_Title_Ef <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_14; ?>">
               ...
               <div class="<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_26; ?> Ov_TotalSoft"></div>
							...
							<?php }else{ ?>
								<?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_29==1){ ?>
             <a id="TotalSoft_GV_PE_<?php echo $Total_Soft_Gallery_Video; ?>_<?php echo $i + 1; ?>" style="display:none;" class="noshow1 TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video; ?> <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_07; ?> swipebox<?php echo $Total_Soft_Gallery_Video; ?>-video-TotSoft<?php echo $Total_Soft_Gallery_Video; ?>" href="<?php echo $TS_GV_PE_VSRST; ?>" name="<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>"> <img class="TotalSoft_HZ2" alt="<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>" src="<?php echo str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL); ?>"/> <span style="display:inline-block;" class="TotalSoft_Title_Ef <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_14; ?>">
												<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>
															<?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_15==1||$TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_15=='true'){ ?>
                 <br/><i class="<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_16; ?> TotalSoft_PI"></i>
															<?php } ?>
    ...
    jQuery(document).ready(function() {
      ...
      jQuery('.TotalSoft_H_Ef<?php echo $Total_Soft_Gallery_Video;?>').each(function() {
        if(jQuery(this).find('img').attr("src")!="") {
          array_images<?php echo $Total_Soft_Gallery_Video;?>.push(jQuery(this).find('img').attr("src"));
        }
      })
...
<?php }
  ...
  <style type="text/css">
      ...
      .TS_GV_ClG_<?php echo $Total_Soft_Gallery_Video;?> {
          ...
          text-align: center;
          float: left;
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_19 == 'fallPerspective'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_19 == 'fly'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_19 == 'flip'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_19 == 'helix'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_19 == 'popUp'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }?>
      }
      ...
      <?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01 == '1'){ ?> width: calc(100% - 1em);
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01 == '2'){ ?> width: calc(49% - 1em);
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01 == '3'){ ?> width: calc(32.3% - 1em);
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01 == '4'){ ?> width: calc(24% - 1em);
      <?php }else{ ?> width: calc(19% - 1em);
      <?php }?> display: inline-block;
          ...
          overflow: hidden;
          opacity: 0;
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_19 == 'moveUp'){ ?> -webkit-transform: translateY(200px);
          -moz-transform: translateY(200px);
          transform: translateY(200px);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_19 == 'scaleUp'){ ?> -webkit-transform: scale(0.6);
          -moz-transform: scale(0.6);
          transform: scale(0.6);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_19 == 'fallPerspective'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform: translateZ(400px) translateY(300px) rotateX(-90deg);
          -moz-transform: translateZ(400px) translateY(300px) rotateX(-90deg);
          transform: translateZ(400px) translateY(300px) rotateX(-90deg);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_19 == 'fly'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform-origin: 50% 50% -300px;
          -moz-transform-origin: 50% 50% -300px;
          ...
          -moz-transform: rotateX(-180deg);
          transform: rotateX(-180deg);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_19 == 'flip'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform-origin: 0% 0%;
          -moz-transform-origin: 0% 0%;
          ...
          -moz-transform: rotateX(-80deg);
          transform: rotateX(-80deg);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_19 == 'helix'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform: rotateY(-180deg);
          -moz-transform: rotateY(-180deg);
          transform: rotateY(-180deg);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_19 == 'popUp'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform: scale(0.4);
          -moz-transform: scale(0.4);
  ...
  <div class="TS_GV_ClG_<?php echo $Total_Soft_Gallery_Video; ?>">
       ...
       <img src="<?php echo plugins_url('../Images/Loading/loading' . $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_20 . '.gif',__FILE__); ?>">
			...
			<?php for($i=0;$i<count($Total_Soft_GalleryV_Videos);$i ++){ ?>
				<?php if(str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL)==''){
					...
					$TS_GV_CG_VSR=str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL);
				} ?>
				<?php if($Total_Soft_GalleryV_Man[0]->TotalSoftGallery_Video_ShowType=='All'){ ?>
       <div class="TS_GV_ClG_Div1_Main_<?php echo $Total_Soft_Gallery_Video; ?>" onclick="TS_GV_ClG_Div_Full<?php echo $Total_Soft_Gallery_Video; ?>(<?php echo $Total_Soft_Gallery_Video; ?>, <?php echo $i; ?>)">
         <div class="TS_GV_ClG_Div1_<?php echo $Total_Soft_Gallery_Video; ?>">
           <div class="TS_GV_ClG_Div2_<?php echo $Total_Soft_Gallery_Video; ?>">
             <img id="TS_GV_ClG_Div2_Img_<?php echo $Total_Soft_Gallery_Video . '_' . $i; ?>" src="<?php echo str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL) ?>" alt="<?php echo $TS_GV_CG_VSR; ?>"/>
												<?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_02=='effect01'){ ?>
     ...
     <div class="TotalSoftcenter" style="float: none !important;" id="TotalSoft_VG_CG_PageDiv_<?php echo $Total_Soft_Gallery_Video; ?>">
                 ...
                 <i class="totalsoft totalsoft-<?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_17; ?>" style="margin-left: 5px;"></i>
															<?php } ?>
							</span> <input type="text" style="display:none;" id="TotalSoft_VG_CG_Page_<?php echo $Total_Soft_Gallery_Video; ?>" value="1">
     </div>
			<?php } ?>
     ...
     <div class="TS_GV_ClG_Div_box_div1_<?php echo $Total_Soft_Gallery_Video; ?> TS_GV_ClG_Div_box_div1_<?php echo $Total_Soft_Gallery_Video; ?>_<?php echo $i; ?>">
       ...
       <div class="TS_GV_ClG_Div_videoTD_<?php echo $Total_Soft_Gallery_Video; ?>">
        ...
        <div style='margin-top:10px; position: relative;'>
          <a class="TotalSoft_GV_CG_Link_<?php echo $Total_Soft_Gallery_Video; ?>" href="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VLink; ?>" <?php if($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VONT=='true'){
											echo 'target="_blank"';
										} ?>>
  ...
  <script type="text/javascript">
    ...
    function TS_GV_ClG_Div_Full<?php echo $Total_Soft_Gallery_Video;?>(id, num) {
      ...
      setTimeout(function() {
        ...
        if(isvideotf=='true') {
          if(iframesource.indexOf('start')=== -1) {
...
<?php }
else if($Total_Soft_GalleryV_Type[0]->TotalSoftGalleryV_SetType=='Space Gallery'){ ?>
  <style type="text/css">
      ...
      <?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01 == 'fallPerspective'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01 == 'fly'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01 == 'flip'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01 == 'helix'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01 == 'popUp'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01 == 'animno' || $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01 == 'animsc' || $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01 == 'animtr'){ ?> -webkit-perspective: 1000px;
          -moz-perspective: 1000px;
          perspective: 1000px;
      <?php }?> float: left !important;
          width: 100%;
      }
      ...
      .TotalSoft_GV_SG_Item_<?php echo $Total_Soft_Gallery_Video;?> {
          ...
          position: relative;
      <?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01 == 'moveUp'){ ?> -webkit-transform: translateY(200px) translateZ(0);
          -moz-transform: translateY(200px) translateZ(0);
          transform: translateY(200px) translateZ(0);
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01 == 'scaleUp'){ ?> -webkit-transform: scale(0.6) translateZ(0);
          -moz-transform: scale(0.6) translateZ(0);
          transform: scale(0.6) translateZ(0);
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01 == 'fallPerspective'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform: translateZ(400px) translateY(300px) rotateX(-90deg);
          -moz-transform: translateZ(400px) translateY(300px) rotateX(-90deg);
          transform: translateZ(400px) translateY(300px) rotateX(-90deg);
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01 == 'fly'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform-origin: 50% 50% -300px;
          -moz-transform-origin: 50% 50% -300px;
      ...
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01 == 'flip'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform-origin: 0% 0%;
          -moz-transform-origin: 0% 0%;
      ...
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01 == 'helix'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform: rotateY(-180deg) translateZ(0);
          -moz-transform: rotateY(-180deg) translateZ(0);
          transform: rotateY(-180deg) translateZ(0);
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01 == 'popUp'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform: scale(0.4) translateZ(0);
          -moz-transform: scale(0.4) translateZ(0);
          transform: scale(0.4) translateZ(0);
      <?php }else{ ?> -webkit-transform: translateZ(0);
          -moz-transform: translateZ(0);
          transform: translateZ(0);
      <?php }?>
      }

      .TotalSoft_GV_SG_Videodiv_<?php echo $Total_Soft_Gallery_Video;?> {
          width: 100%;
          padding-top: 56.25%;
          position: relative;
      }

      .TotalSoft_GV_SG_Imagediv_<?php echo $Total_Soft_Gallery_Video;?> {
          width: 100%;
          display: block;
          text-align: center;
          position: relative;
      ...
      .TotalSoft_GV_SG_Imagediv_<?php echo $Total_Soft_Gallery_Video;?> img {
          width: 100%;
          height: auto;
          margin: 0 auto !important;
      }
      ...
      <?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_08 == 'transparent'){ ?> background: transparent !important;
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_08 == 'color'){ ?> background-color: <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09;?> !important;
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_08 == 'gradient1'){ ?> background: <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09;?>;
      ...
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_08 == 'gradient2'){ ?> background: <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09;?>;
      ...
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_08 == 'gradient3'){ ?> background: <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09;?>;
      ...
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_08 == 'gradient4'){ ?> background: -webkit-linear-gradient(<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09;?>, <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_10;?>, <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09;?>);
      ...
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_08 == 'gradient5'){ ?> background: -webkit-linear-gradient(left, <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09;?>, <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_10;?>, <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09;?>);
      ...
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_08 == 'gradient6'){ ?> background: -webkit-repeating-linear-gradient(<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09;?>, <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_10;?>, 10%, <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09;?> 20%);
      ...
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_08 == 'gradient7'){ ?> background: -webkit-repeating-linear-gradient(45deg,<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09;?>,<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_10;?> 7%,<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09;?> 10%);
      ...
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_08 == 'gradient8'){ ?> background: -webkit-repeating-linear-gradient(190deg,<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09;?>,<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_10;?> 7%,<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09;?> 10%);
      ...
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_08 == 'gradient9'){ ?> background: -webkit-repeating-linear-gradient(90deg,<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09;?>,<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_10;?> 7%,<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09;?> 10%);
      ...
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_08 == 'gradient10'){ ?> background: <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09;?>;
      ...
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_08 == 'gradient11'){ ?> background: <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09;?>;
      ...
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_08 == 'gradient12'){ ?> background: -webkit-radial-gradient(circle, <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09;?>, <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_10;?>, <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09;?>);
      ...
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_08 == 'gradient13'){ ?> background: -webkit-repeating-radial-gradient(<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09;?>, <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_10;?> 10%, <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_09;?> 15%);
      ...
      .TotalSoft_GV_SG_VideoPMspan_<?php echo $Total_Soft_Gallery_Video;?>:hover::before {
          opacity: 1;
          right: 0px;
          top: 0px;
      }

      .TotalSoft_GV_SG_VideoPMspan_<?php echo $Total_Soft_Gallery_Video;?>:hover::after {
          opacity: 1;
          left: 0px;
          bottom: 0px;
      }
      ...
      .TotalSoft_GV_SG_VideoPM_<?php echo $Total_Soft_Gallery_Video;?>:before {
      <?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_22 == 'none'){ ?> content: "";
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_22 == 'file-video-o'){ ?> content: "\f1c8";
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_22 == 'video-camera'){ ?> content: "\f03d";
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_22 == 'camera-retro'){ ?> content: "\f083";
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_22 == 'eye'){ ?> content: "\f06e";
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_22 == 'film'){ ?> content: "\f008";
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_22 == 'youtube-play'){ ?> content: "\f16a";
      <?php }?> font-family: FontAwesome;
      ...
      <?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_24 == 'before'){ ?> left: 0;
      <?php }else{ ?> right: 0;
      <?php }?> top: 0;
          opacity: 0;
          height: 100%;
      ...
      .TotalSoft_GV_SG_VideoPM_<?php echo $Total_Soft_Gallery_Video;?>:hover {
      <?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_24 == 'before'){ ?> text-indent: 20px;
      <?php }else{ ?> text-indent: -20px;
      <?php }?>
      }
      ...
      <?php }?> font-family: FontAwesome;
          ...
          -ms-flex-pack: center;
          justify-content: center;
      <?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_24 == 'before'){ ?> left: -<?php echo 2*$TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_23;?>px;
      <?php }else{ ?> right: -<?php echo 2*$TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_23;?>px;
      <?php }?> top: 0;
          height: 100%;
      ...
      .TotalSoft_GV_SG_VideoPM_<?php echo $Total_Soft_Gallery_Video;?>:hover:before {
      <?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_24 == 'before'){ ?> left: 0px;
      <?php }else{ ?> right: 0px;
      <?php }?> text-indent: 0px;
      }
      ...
      <?php }?>
      .TotalSoft_GV_SG_VideoPMicon_<?php echo $Total_Soft_Gallery_Video;?> {
      <?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_24 == 'before'){ ?> margin-right: 5px;
      <?php }else{ ?> margin-left: 5px;
      <?php }?> font-size: <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_23;?>px;
      }

      .TotalSoft_GV_SG_Item_<?php echo $Total_Soft_Gallery_Video;?> iframe, .TotalSoft_GV_SG_Item_<?php echo $Total_Soft_Gallery_Video;?> video {
          position: absolute;
          width: 100%;
          height: 100%;
          top: 0;
      ...
      .TS_GV_SG_Div_video_<?php echo $Total_Soft_Gallery_Video;?> iframe {
          position: absolute;
          top: 0;
          left: 0;
          width: 100% !important;
      ...
      .TS_GV_SG_Div_video_<?php echo $Total_Soft_Gallery_Video;?> img {
          position: absolute;
          top: 0;
          left: 50%;
          width: auto;
      ...
      .TS_GV_SG_Div_box_div3_<?php echo $Total_Soft_Gallery_Video;?>::-webkit-scrollbar {
          width: 6px;
      }
      ...
      .TS_GV_SG_Div_box_div3_LAT_<?php echo $Total_Soft_Gallery_Video;?> {
          position: relative;
          padding: 10px 0;
      }
      ...
      .TS_GV_SG_Div_box_div3_LAT_<?php echo $Total_Soft_Gallery_Video;?> span {
          ...
          display: block;
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_01 == 'left'){ ?> float: left;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_01 == 'right'){ ?> float: right;
      ...
      .TS_GV_SG_Div_box_div3_<?php echo $Total_Soft_Gallery_Video;?> p {
          margin: 0;
          padding: 0;
      }
      ...
      .TotalSoft_GV_SG_Link_<?php echo $Total_Soft_Gallery_Video;?> {
          ...
          text-align: center;
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_09 == 'left'){ ?> margin-right: auto;
          margin-left: 0;
          width: max-content;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_09 == 'right'){ ?> margin-left: auto;
          margin-right: 0;
          width: max-content;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_09 == 'center'){ ?> margin: 0 auto;
          width: max-content;
      <?php }?> font-family: <?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_10;?>;
      ...
      .TS_GV_SG_Pagination_<?php echo $Total_Soft_Gallery_Video;?> li {
          display: inline;
          text-align: center;
          margin-left: 0 !important;
      }
      ...
      .TS_GV_SG_Pagination_<?php echo $Total_Soft_Gallery_Video;?> span.active:hover:after {
          display: none;
      }
    ...
    jQuery(document).ready(function() {
      ...
      jQuery('.TotalSoft_GV_SG_Item_<?php echo $Total_Soft_Gallery_Video;?>').each(function() {
        ...
        if(jQuery(this).find('iframe').attr("src")!="" && jQuery(this).find('iframe').attr("src")!=undefined) {
          array_videos<?php echo $Total_Soft_Gallery_Video;?>.push(jQuery(this).find('iframe').attr("src"));
        }
      })
    ...
    <div class="TotalSoft_GV_SG_Grid_<?php echo $Total_Soft_Gallery_Video; ?>">
         ...
         <div class="TotalSoft_GV_SG_Item_<?php echo $Total_Soft_Gallery_Video; ?> TotalSoft_GV_SG_Item_<?php echo $Total_Soft_Gallery_Video; ?>_<?php echo $i; ?>">
            ...
            <div class="TotalSoft_GV_SG_Imagediv_<?php echo $Total_Soft_Gallery_Video; ?>">
              <img src="<?php echo  str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL); ?>">
            </div>
										<?php }else{ ?>
            <div class="TotalSoft_GV_SG_Videodiv_<?php echo $Total_Soft_Gallery_Video; ?>">
													<?php if(strpos(str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL),'.mp4')>0){ ?>
               <video controls poster="<?php echo  str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL); ?>">
                 <source src="<?php echo str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL); ?>" type="video/mp4">
               </video>
													<?php }else{ ?>
														<?php if(strpos(str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL),'start')){ ?>
                 <iframe src="<?php echo str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL); ?>&autoplay=0&controls=1&showinfo=0&autohide=1&rel=0&iv_load_policy=3" frameborder="0" webkitAllowFullScreen></iframe>
														<?php }else{ ?>
                 <iframe src="<?php echo str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL); ?>?autoplay=0&controls=1&showinfo=0&autohide=1&rel=0&iv_load_policy=3" frameborder="0" webkitAllowFullScreen></iframe> <?php } ?>
													<?php } ?>
            </div>
										<?php } ?>
    ...
    <input type="text" style="display: none;" class="TS_VG_SG_AE_<?php echo $Total_Soft_Gallery_Video; ?>" value="<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01; ?>">
     ...
     <div class="TotalSoftcenter" id="TotalSoft_VG_SG_PageDiv_<?php echo $Total_Soft_Gallery_Video; ?>">
                 ...
                 <i class="totalsoft totalsoft-<?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_32; ?>" style="margin-left: 5px;"></i>
															<?php } ?>
							</span> <input type="text" style="display:none;" id="TotalSoft_VG_SG_Page_<?php echo $Total_Soft_Gallery_Video; ?>" value="1">
     </div>
			<?php } ?>
  </div>
     ...
     <div class="TS_GV_SG_Div_box_div1_<?php echo $Total_Soft_Gallery_Video; ?> TS_GV_SG_Div_box_div1_<?php echo $Total_Soft_Gallery_Video; ?>_<?php echo $i; ?>">
       ...
       <div class="TS_GV_SG_Div_box_div3_<?php echo $Total_Soft_Gallery_Video; ?> TS_GV_SG_Div_box_div3_<?php echo $Total_Soft_Gallery_Video; ?>_<?php echo $i; ?>">
            ...
            <div style='position: relative;'>
              <a class="TotalSoft_GV_SG_Link_<?php echo $Total_Soft_Gallery_Video; ?>" href="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VLink; ?>" <?php if($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VONT=='true'){
															echo 'target="_blank"';
														} ?>>

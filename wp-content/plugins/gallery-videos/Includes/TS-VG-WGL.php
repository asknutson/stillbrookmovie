...
if($Total_Soft_GalleryV_Type[0]->TotalSoftGalleryV_SetType=='Grid Video Gallery'){ ?>
  <style type="text/css">
      .grid-gallery<?php echo $Total_Soft_Gallery_Video; ?> > ul {
          list-style: none;
          margin: 0;
          padding: 0 !important;
      }

      .grid-gallery<?php echo $Total_Soft_Gallery_Video; ?> figure {
          margin: 0;
      }

      .grid-gallery<?php echo $Total_Soft_Gallery_Video; ?> figure img {
          display: block;
          cursor: pointer;
          width: 100%;
          margin: 0 !important;
      ...
      .grid-gallery<?php echo $Total_Soft_Gallery_Video; ?> figcaption > h3, .grid-gallery<?php echo $Total_Soft_Gallery_Video; ?> figcaption p {
          margin: 0;
          margin-top: 5px;
      ...
      .grid<?php echo $Total_Soft_Gallery_Video; ?> {
          margin: 0 auto;
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_26 == 'fallPerspective'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_26 == 'fly'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_26 == 'flip'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_26 == 'helix'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_26 == 'popUp'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }?>
      }

      .grid<?php echo $Total_Soft_Gallery_Video; ?> li:before {
          content: '' !important;
        }
      ...
      .grid<?php echo $Total_Soft_Gallery_Video; ?> .imgLiii {
          ...
          opacity: 1;
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_26 == 'moveUp'){ ?> -webkit-transform: translateY(200px);
          -moz-transform: translateY(200px);
          transform: translateY(200px);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_26 == 'scaleUp'){ ?> -webkit-transform: scale(0.6);
          -moz-transform: scale(0.6);
          transform: scale(0.6);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_26 == 'fallPerspective'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform: translateZ(400px) translateY(300px) rotateX(-90deg);
          -moz-transform: translateZ(400px) translateY(300px) rotateX(-90deg);
          transform: translateZ(400px) translateY(300px) rotateX(-90deg);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_26 == 'fly'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
      ...
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_26 == 'flip'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
      ...
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_26 == 'helix'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform: rotateY(-180deg);
          -moz-transform: rotateY(-180deg);
          transform: rotateY(-180deg);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_26 == 'popUp'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
      ...
      .grid<?php echo $Total_Soft_Gallery_Video; ?> figure {
      ...
      .slideshow<?php echo $Total_Soft_Gallery_Video; ?> li.show<?php echo $Total_Soft_Gallery_Video; ?> {
          visibility: visible;
      }
      ...
      .current<?php echo $Total_Soft_Gallery_Video; ?> {
      ...
      .slideshow<?php echo $Total_Soft_Gallery_Video; ?> figcaption {
          padding-bottom: 5px;
      }

      .slideshow<?php echo $Total_Soft_Gallery_Video; ?> ul li figure iframe, .slideshow<?php echo $Total_Soft_Gallery_Video; ?> ul li figure video {
          height: 250px;
          margin: 0;
          display: block;
      }

      .slideshow<?php echo $Total_Soft_Gallery_Video; ?> ul li figure img {
          height: 250px;
          width: auto;
          margin: 0 auto !important;
      }

      .slideshow<?php echo $Total_Soft_Gallery_Video; ?> figcaption .TotalSoft_GV_GG_SP {
          overflow-x: auto;
          margin-top: 5px;
          padding-right: 10px;
          padding: 0 20px;
      ...
      .slideshow<?php echo $Total_Soft_Gallery_Video; ?> figcaption .TotalSoft_GV_GG_SP ul li {
          top: unset !important;
          position: relative;
          margin-bottom: 0px;
          margin-top: 0px;
      ...
      .slideshow<?php echo $Total_Soft_Gallery_Video; ?> figcaption .TotalSoft_GV_GG_SP ol li {
          top: unset !important;
          position: relative;
          margin-bottom: 0px;
          margin-top: 0px;
      ...
      .slideshow<?php echo $Total_Soft_Gallery_Video; ?> figcaption .TotalSoft_GV_GG_SP ul {
          margin-bottom: 0px;
          margin-left: 10px;
          line-height: 15px;
          position: relative !important;
      ...
      .slideshow<?php echo $Total_Soft_Gallery_Video; ?> nav span:before, .slideshow<?php echo $Total_Soft_Gallery_Video; ?> nav span:after {
          content: none;
      }
      ...
      .slideshow<?php echo $Total_Soft_Gallery_Video; ?> nav span.nav-prev {
          left: 0;
      }

      .slideshow<?php echo $Total_Soft_Gallery_Video; ?> nav span.nav-next {
          right: 0;
      }
      ...
      .slideshow<?php echo $Total_Soft_Gallery_Video; ?> figcaption p, .main-container {
          font: inherit;
      }

      .grid<?php echo $Total_Soft_Gallery_Video; ?> li:hover figure {
      <?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_06 == 'none'){ ?> -webkit-filter: none;
          filter: none;
      <?php } else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_06 == 'blur'){ ?> -webkit-filter: blur(2px);
          filter: blur(2px);
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_06 == 'brightness'){ ?> -webkit-filter: brightness(120%);
          filter: brightness(120%);
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_06 == 'contrast'){ ?> -webkit-filter: contrast(150%);
          filter: contrast(150%);
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_06 == 'grayscale'){ ?> -webkit-filter: grayscale(100%);
          filter: grayscale(100%);
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_06 == 'hue-rotate'){ ?> -webkit-filter: hue-rotate(90deg);
          filter: hue-rotate(90deg);
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_06 == 'invert'){ ?> -webkit-filter: invert(100%);
          filter: invert(100%);
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_06 == 'drop-shadow'){ ?> -webkit-filter: drop-shadow(0px 0px 3px <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_08;?>);
          filter: drop-shadow(0px 0px 3px <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_08;?>);
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_06 == 'opacity'){ ?> -webkit-filter: opacity(<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_07*100;?>%);
          filter: opacity(<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_07*100;?>%);
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_06 == 'saturate'){ ?> -webkit-filter: saturate(8);
          filter: saturate(8);
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_06 == 'sepia'){ ?> -webkit-filter: sepia(100%);
          filter: sepia(100%);
      <?php }else if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_06 == 'contrast-brightness'){ ?> -webkit-filter: contrast(120%) brightness(120%);
      ...
      .grid-gallery<?php echo $Total_Soft_Gallery_Video; ?> {
          width: 100%
      }
      ...
      .grid-gallery<?php echo $Total_Soft_Gallery_Video; ?> figcaption p {
          margin-bottom: 0 !important;
      }
      ...
      .slideshow<?php echo $Total_Soft_Gallery_Video; ?> figure ol, .slideshow<?php echo $Total_Soft_Gallery_Video; ?> figure ul {
          margin-left: 0 !important;
      }

      #GRU<?php echo $Total_Soft_Gallery_Video; ?> figure figcaption ul, #GRU<?php echo $Total_Soft_Gallery_Video; ?> figure figcaption ol {
          left: 0;
          margin-left: 0;
      }

      #GRU<?php echo $Total_Soft_Gallery_Video; ?> figure figcaption ul > ul {
          display: list-item;
          list-style-type: disc;
      }

      .grid<?php echo $Total_Soft_Gallery_Video; ?>-sizer {
          margin: 0 !important;
          padding: 0 !important;
      }
      ...
      .slideshow<?php echo $Total_Soft_Gallery_Video; ?> figcaption p {
          margin-bottom: 0 !important;
      ...
      #pagination<?php echo $Total_Soft_Gallery_Video; ?> li {
      ...
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_24 != 'none'){ ?> border: 1px solid <?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_25;?> !important;
      <?php } else { ?> border: none !important;
      <?php }?> line-height: 1 !important;
          display: block;
          cursor: pointer;
          padding: 2px 10px;
      }
      ...
      .TotalSoftGV_GVG_LM<?php echo $Total_Soft_Gallery_Video; ?> {
          ...
          font-size: <?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_16;?>px;
          font-family: <?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_17;?>;
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_24 != 'none'){ ?> border: 1px solid<?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_25;?>;
      <?php } else { ?> border: none !important;
      <?php }?> cursor: pointer;
          display: block;
      ...
      .nav-close-RW<?php echo $Total_Soft_Gallery_Video; ?> li.current<?php echo $Total_Soft_Gallery_Video; ?> {
          position: relative;
          z-index: 9;
      }
      ...
      .slideshow<?php echo $Total_Soft_Gallery_Video; ?> figcaption .TotalSoft_GV_GG_SP::-webkit-scrollbar {
          width: 0.5em;
      }
      ...
      #pagination<?php echo $Total_Soft_Gallery_Video; ?> {
        ...
        <ul id="GRU<?php echo $Total_Soft_Gallery_Video; ?>" class="GRU<?php echo $Total_Soft_Gallery_Video; ?> grid<?php echo $Total_Soft_Gallery_Video; ?>" style='margin:0px;list-style:none;max-width:none;'>
          <li class="grid<?php echo $Total_Soft_Gallery_Video; ?>-sizer"></li>
             ...
             <li class='imgLiii' id="TotalSoft_GV_GVG_<?php echo $Total_Soft_Gallery_Video; ?>_<?php echo $i + 1; ?>">
               <figure> <?php
																$url=str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL);
...
//													
                  ...
                  <figcaption>
                     ...
                     <h3><?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?></h3>
																			...
																			<?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_02=='true'){ ?>
																				<?php $string=do_shortcode(html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VDesc));
                   ...
                   <img src="<?php echo $url; ?>" alt="img<?php echo $Total_Soft_GalleryV_Videos[$i]->id; ?>"/>
                    ...
                    <figcaption>
                       ...
                       <h3><?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?></h3>
																					<?php } ?>
																					<?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_02=='true'){
																						$string =do_shortcode(html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VDesc));
																						$replace=str_replace('<li>','<ul>',$string);
																						echo $replace;
																					} ?>
                    </figcaption>
      ...
      <section class="slideshow<?php echo $Total_Soft_Gallery_Video; ?>">
        <ul class='nav-close-RW<?php echo $Total_Soft_Gallery_Video; ?>'>
									<?php for($i=0;$i<count($Total_Soft_GalleryV_Videos);$i ++){ ?>
										<?php if(str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL)!=''){ ?>
											<?php if(strpos(str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL),'.mp4')>- 1){ ?>
                 ...
                 <figure>
                    ...
                    <figcaption>
                       ...
                       <div class="TotalSoft_GV_GG_SP">
																								<?php echo do_shortcode(html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VDesc)); ?>
                       </div>
																					<?php } ?>
																					<?php if($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VLink!=''){ ?>
                       <div style='height:30px;margin-top:10px;text-align:right;'>
                         <a class="TotalSoft_GV_GVG_Link<?php echo $Total_Soft_Gallery_Video; ?>" href="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VLink; ?>" <?php if($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VONT=='true'){
																										echo 'target="_blank"';
																									} ?>><?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_05; ?></a>
                       </div>
																					<?php } ?>
                    </figcaption>
																		<?php } ?>
                   <video id="videocontainer_<?php echo $Total_Soft_Gallery_Video; ?>_<?php echo $i; ?>" controls poster="<?php echo str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL); ?>">
																				<?php
																				$url=str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL);
																				if(strpos($url,'http')!==false){
        ...
        <nav>
          <span class="icon nav-prev"><i class="<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_32; ?>"></i></span> <span class="icon nav-next"><i class="<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_33; ?>"></i></span> <span class="icon nav-close nav-close-TotalSoft" id="close-all-videos"><i class="<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_37; ?>"></i></span>
        </nav>
      </section>
    </div>
  </div>
  ...
  <script>
    ...
    jQuery(document).ready(function() {
      ...
      if(tema_name=="Oneline Lite" || tema_name=="Oshi" || tema_name=="OceanWP" || tema_name=="Businessly") {
        if(size <= 480) {
          jQuery('.slideshow<?php echo $Total_Soft_Gallery_Video; ?> ul li figure iframe').css({
...
//-->
  ...
  <script>
    ...
    function Total_Soft_GV_GVG_PagePresp<?php echo $Total_Soft_Gallery_Video; ?>() {
      ...
      jQuery('.slideshow<?php echo $Total_Soft_Gallery_Video; ?> ul li figure video').css('max-width', '100%');
...
//-->
  ...
  <script type="text/javascript">
    ...
    ;(function(window) {
      ...
      }, transEndEventName<?php echo $Total_Soft_Gallery_Video; ?> =transEndEventNames[Modernizr.prefixed('transition')], support={
      ...
      CBPGridGallery<?php echo $Total_Soft_Gallery_Video; ?>.prototype._initMasonry<?php echo $Total_Soft_Gallery_Video; ?> =function() {
        ...
        imagesLoaded(grid<?php echo $Total_Soft_Gallery_Video; ?>, function() {
          ...
          new Masonry(grid<?php echo $Total_Soft_Gallery_Video; ?>, {
            itemSelector: 'li', columnWidth: grid<?php echo $Total_Soft_Gallery_Video; ?>.querySelector('.grid<?php echo $Total_Soft_Gallery_Video; ?>-sizer')
          });
        });
      };
      CBPGridGallery<?php echo $Total_Soft_Gallery_Video; ?>.prototype._initEvents<?php echo $Total_Soft_Gallery_Video; ?> =function() {
        ...
        this.ctrlClose2<?php echo $Total_Soft_Gallery_Video; ?>.addEventListener('click', function() {
          self._closeSlideshow<?php echo $Total_Soft_Gallery_Video; ?>();
        });
        // window resize
      ...
      CBPGridGallery<?php echo $Total_Soft_Gallery_Video; ?>.prototype._navigate<?php echo $Total_Soft_Gallery_Video; ?> =function(dir) {
        ...
        this._setViewportItems<?php echo $Total_Soft_Gallery_Video; ?>();
        var self=this, itemWidth=this.currentItem<?php echo $Total_Soft_Gallery_Video; ?>.offsetWidth != undefined ? this.currentItem<?php echo $Total_Soft_Gallery_Video; ?>.offsetWidth : 0 , // positions for the centered/current item, both the side items and the incoming ones
          transformLeftStr=support.support3d ? 'translate3d(-' + Number(getViewportW<?php echo $Total_Soft_Gallery_Video; ?>() / 2 + itemWidth / 2) + 'px, 0, -150px)' : 'translate(-' + Number(getViewportW<?php echo $Total_Soft_Gallery_Video; ?>() / 2 + itemWidth / 2) + 'px)', transformRightStr=support.support3d ? 'translate3d(' + Number(getViewportW<?php echo $Total_Soft_Gallery_Video; ?>() / 2 - itemWidth / 2) + 'px, 0, -150px)' : 'translate(' + Number(getViewportW<?php echo $Total_Soft_Gallery_Video; ?>() / 2 - itemWidth / 2) + 'px)', transformCenterStr='', transformOutStr, transformIncomingStr, // incoming item
        ...
        if(dir==='next') {
          ...
          transformOutStr=support.support3d ? 'translate3d( ' + Number((getViewportW<?php echo $Total_Soft_Gallery_Video; ?>() * 2) / 2 - itemWidth / 2) - itemWidth + 'px, 0, -150px )' : 'translate(' + Number((getViewportW<?php echo $Total_Soft_Gallery_Video; ?>() * 2) / 2 + itemWidth / 2) + itemWidth + 'px)';
            transformOutStr=support.support3d ? 'translate3d( ' + Number((getViewportW<?php echo $Total_Soft_Gallery_Video; ?>() * 2) / 2 - itemWidth / 2) - itemWidth + 'px, 0, -150px )' : 'translate(' + Number(getViewportW<?php echo $Total_Soft_Gallery_Video; ?>() / 2 - itemWidth / 2) + 'px)';
          transformIncomingStr=support.support3d ? 'translate3d( -' + Number((getViewportW<?php echo $Total_Soft_Gallery_Video; ?>() * 2) / 2 - itemWidth / 2) + 'px, 0, -150px )' : 'translate(-' + Number((getViewportW<?php echo $Total_Soft_Gallery_Video; ?>() * 2) / 2 + itemWidth / 2) + 'px)';
          var size=jQuery(window).width();
          if(size < 820) {
            var items=jQuery('.nav-close-RW<?php echo $Total_Soft_Gallery_Video; ?>').children('li');
        ...
        var slide<?php echo $Total_Soft_Gallery_Video; ?> =function() {
          ...
          var onEndTransitionFn<?php echo $Total_Soft_Gallery_Video; ?> =function(ev) {
            ...
            if(self.prevItem<?php echo $Total_Soft_Gallery_Video; ?> && dir==='next') {
			  ...
			  if(jQuery(pre[0]).attr('class')!="videocontainer show<?php echo $Total_Soft_Gallery_Video; ?> current<?php echo $Total_Soft_Gallery_Video; ?>"){
				if(jQuery(pre[0]).attr('class')!="iframecontainer show<?php echo $Total_Soft_Gallery_Video; ?> current<?php echo $Total_Soft_Gallery_Video; ?>") {
      ...
      CBPGridGallery<?php echo $Total_Soft_Gallery_Video; ?>.prototype._closeSlideshow<?php echo $Total_Soft_Gallery_Video; ?> =function(pos) {
        ...
        var self=this, onEndTransitionFn<?php echo $Total_Soft_Gallery_Video; ?> =function(ev) {
          if(support.transitions) {
          ...
          self.slideshowItems<?php echo $Total_Soft_Gallery_Video; ?>.forEach(function(item) {
            setTransform<?php echo $Total_Soft_Gallery_Video; ?>(item, '');
          });
      ...
      CBPGridGallery<?php echo $Total_Soft_Gallery_Video; ?>.prototype._resizeHandler=function() {
        ...
        if(this._resizeTimeout<?php echo $Total_Soft_Gallery_Video; ?> ) {
          clearTimeout(this._resizeTimeout<?php echo $Total_Soft_Gallery_Video; ?> );
        }
...
if($Total_Soft_GalleryV_Type[0]->TotalSoftGalleryV_SetType=='LightBox Video Gallery'){ ?>
  ...
  <style type="text/css">
      .totalsoft-gv-lvg-content<?php echo $Total_Soft_Gallery_Video; ?>, .totalsoft-gv-lvg-area<?php echo $Total_Soft_Gallery_Video; ?> {
          ...
          margin: 0 !important;
          text-align: center;
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_35 == 'fallPerspective'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_35 == 'fly'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_35 == 'flip'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_35 == 'helix'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_35 == 'popUp'){ ?> -webkit-perspective: 1300px;
          -moz-perspective: 1300px;
          perspective: 1300px;
      <?php }?>
      }
      ...
      /**** PORTFOLIO STYLES*****/
      .totalsoft-gv-lvg-image-block<?php echo $Total_Soft_Gallery_Video; ?> {
          display: block;
          position: relative;
          width: 100%;
          height: 100%;
      ...
      div.pp_overlay<?php echo $Total_Soft_Gallery_Video; ?> {
          background: #000;
          display: none;
          left: 0;
          position: absolute;
      ...
      .pp_top<?php echo $Total_Soft_Gallery_Video; ?> {
          height: 20px;
          position: relative;
      }

      * html .pp_top<?php echo $Total_Soft_Gallery_Video; ?> {
          padding: 0 20px;
      }

      .pp_top<?php echo $Total_Soft_Gallery_Video; ?> .pp_left<?php echo $Total_Soft_Gallery_Video; ?> {
          height: 20px;
          left: 0;
          position: absolute;
          width: 20px;
      ...
      .pp_top<?php echo $Total_Soft_Gallery_Video; ?> .pp_middle<?php echo $Total_Soft_Gallery_Video; ?> {
          height: 20px;
          left: 20px;
          position: absolute;
          right: 20px;
      ...
      * html .pp_top<?php echo $Total_Soft_Gallery_Video; ?> .pp_middle<?php echo $Total_Soft_Gallery_Video; ?> {
          left: 0;
          position: static;
      }
      ...
      .pp_content<?php echo $Total_Soft_Gallery_Video; ?> {
          height: 40px;
      }

      .pp_fade<?php echo $Total_Soft_Gallery_Video; ?> {
          display: none;
      }

      .pp_content_container<?php echo $Total_Soft_Gallery_Video; ?> {
          position: relative;
          text-align: left;
          width: 100%;
      }

      .pp_content_container<?php echo $Total_Soft_Gallery_Video; ?> .pp_left<?php echo $Total_Soft_Gallery_Video; ?> {
          padding-left: 20px;
      }

      .pp_content_container<?php echo $Total_Soft_Gallery_Video; ?> .pp_right<?php echo $Total_Soft_Gallery_Video; ?> {
          padding-right: 20px;
      }

      /*---poxel---*/
      .pp_content_container<?php echo $Total_Soft_Gallery_Video; ?> .pp_details<?php echo $Total_Soft_Gallery_Video; ?> {
      ...
      .pp_nav<?php echo $Total_Soft_Gallery_Video; ?> {
          clear: left;
          float: left;
          margin: 3px 0 0 0;
      }

      .pp_nav<?php echo $Total_Soft_Gallery_Video; ?> p {
          float: left;
          margin: 0px 10px;
          margin-top: 1px;
          line-height: 25px;
      ...
      .pp_hoverContainer<?php echo $Total_Soft_Gallery_Video; ?> {
          position: absolute;
          top: 0;
          width: 100% !important;
          z-index: 2000;
      ...
      .pp_gallery<?php echo $Total_Soft_Gallery_Video; ?> {
          left: 50%;
          margin-top: -50px;
          position: absolute;
          z-index: 10000;
      ...
      .pp_gallery<?php echo $Total_Soft_Gallery_Video; ?> ul {
          float: left;
          height: 35px;
          margin: 0 0 0 5px;
          overflow: hidden;
      ...
      .pp_gallery<?php echo $Total_Soft_Gallery_Video; ?> ul a {
      ...
      .pp_gallery<?php echo $Total_Soft_Gallery_Video; ?> ul a:hover, .pp_gallery<?php echo $Total_Soft_Gallery_Video; ?> li.selected a {
          border-color: #fff;
      }

      .pp_gallery<?php echo $Total_Soft_Gallery_Video; ?> ul a img {
          border: 0;
      }

      .pp_gallery<?php echo $Total_Soft_Gallery_Video; ?> li {
          display: block;
          float: left;
          margin: 0 5px 0 0;
      }

      .pp_gallery<?php echo $Total_Soft_Gallery_Video; ?> li.default a {
      ...
      .pp_gallery<?php echo $Total_Soft_Gallery_Video; ?> li.default a img {
          display: none;
      }
      ...
      /*---poxel---*/
      i.pp_close<?php echo $Total_Soft_Gallery_Video; ?> {
          display: block;
          float: right;
          line-height: 22px;
          margin-right: 0px;
      ...
      .pp_bottom<?php echo $Total_Soft_Gallery_Video; ?> {
          height: 20px;
          position: relative;
      }

      * html .pp_bottom<?php echo $Total_Soft_Gallery_Video; ?> {
          padding: 0 20px;
      }

      .pp_bottom<?php echo $Total_Soft_Gallery_Video; ?> .pp_left<?php echo $Total_Soft_Gallery_Video; ?> {
          height: 20px;
          left: 0;
          position: absolute;
          width: 20px;
      ...
      .pp_bottom<?php echo $Total_Soft_Gallery_Video; ?> .pp_middle<?php echo $Total_Soft_Gallery_Video; ?> {
          height: 20px;
          left: 20px;
          position: absolute;
          right: 20px;
      ...
      * html .pp_bottom<?php echo $Total_Soft_Gallery_Video; ?> .pp_middle<?php echo $Total_Soft_Gallery_Video; ?> {
          left: 0;
          position: static;
      }
      ...
      .pp_loaderIcon<?php echo $Total_Soft_Gallery_Video; ?> {
          display: block;
          height: 24px;
          left: 50%;
      ...
      #pp_full_res<?php echo $Total_Soft_Gallery_Video; ?> {
          line-height: 1 !important;
      }
      ...
      #pp_full_res<?php echo $Total_Soft_Gallery_Video; ?> .pp_inline<?php echo $Total_Soft_Gallery_Video; ?> {
          text-align: left;
      }

      #pp_full_res<?php echo $Total_Soft_Gallery_Video; ?> .pp_inline<?php echo $Total_Soft_Gallery_Video; ?> p {
          margin: 0 0 15px 0;
      }

      div.ppt<?php echo $Total_Soft_Gallery_Video; ?> {
          color: #fff;
          display: none;
          font-size: 17px;
          margin: 0 0 5px 15px;
      ...
      .clearfix<?php echo $Total_Soft_Gallery_Video; ?>:after {
          content: ".";
          display: block;
          height: 0;
          clear: both;
      ...
      .clearfix<?php echo $Total_Soft_Gallery_Video; ?> {
          display: inline-block;
      }

      * html .clearfix<?php echo $Total_Soft_Gallery_Video; ?> {
          height: 1%;
      }
      ...
      .totalsoft-gv-lvg-area<?php echo $Total_Soft_Gallery_Video; ?> li {
          ...
          display: inline-block;
          opacity: 0;
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_35 == 'moveUp'){ ?> -webkit-transform: translateY(200px);
          -moz-transform: translateY(200px);
          transform: translateY(200px);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_35 == 'scaleUp'){ ?> -webkit-transform: scale(0.6);
          -moz-transform: scale(0.6);
          transform: scale(0.6);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_35 == 'fallPerspective'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform: translateZ(400px) translateY(300px) rotateX(-90deg);
          -moz-transform: translateZ(400px) translateY(300px) rotateX(-90deg);
          transform: translateZ(400px) translateY(300px) rotateX(-90deg);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_35 == 'fly'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform-origin: 50% 50% -300px;
          -moz-transform-origin: 50% 50% -300px;
          ...
          -moz-transform: rotateX(-180deg);
          transform: rotateX(-180deg);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_35 == 'flip'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform-origin: 0% 0%;
          -moz-transform-origin: 0% 0%;
          ...
          -moz-transform: rotateX(-80deg);
          transform: rotateX(-80deg);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_35 == 'helix'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform: rotateY(-180deg);
          -moz-transform: rotateY(-180deg);
          transform: rotateY(-180deg);
      <?php }else if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_35 == 'popUp'){ ?> -webkit-transform-style: preserve-3d;
          -moz-transform-style: preserve-3d;
          transform-style: preserve-3d;
          -webkit-transform: scale(0.4);
          -moz-transform: scale(0.4);
      ...
      .pp_top<?php echo $Total_Soft_Gallery_Video; ?> div {
          background: none !important;
      }

      .pp_content_container<?php echo $Total_Soft_Gallery_Video; ?> div {
          background: none !important;
      }

      .pp_bottom<?php echo $Total_Soft_Gallery_Video; ?> div {
          background: none !important;
      }
      ...
      ul.pagination<?php echo $Total_Soft_Gallery_Video; ?> li span {
          ...
          height: auto !important;
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_08!='none'){ ?> border: 1px solid <?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_09;?> !important;
      <?php } else { ?> border: none !important;
      <?php }?> line-height: 1 !important;
          display: block !important;
      }
      ...
      .TotalSoftGV_LVG_LM<?php echo $Total_Soft_Gallery_Video; ?> {
          ...
          font-size: <?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_02;?>px;
          font-family: <?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_03;?>;
      <?php if($TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_08!='none'){ ?> border: 1px solid<?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_09;?>;
      <?php } else { ?> border: none !important;
      <?php }?> cursor: pointer;
          display: block;
          padding: 3px !important;
      ...
      .fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?> {
          position: relative;
          overflow: hidden;
          box-sizing: border-box;
      ...
      .fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?>:hover li {
          left: none !important;
      ...
      .pagination<?php echo $Total_Soft_Gallery_Video; ?> li:before {
      ...
      .fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?>:hover .lImgZoom3_<?php echo $Total_Soft_Gallery_Video; ?> {
          width: 150%;
      }
      ...
      .fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?>:hover .lImgZoom5_<?php echo $Total_Soft_Gallery_Video; ?> {
          width: 150%;
      }
      ...
      .fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?>:hover .lImgZoom6_<?php echo $Total_Soft_Gallery_Video; ?> {
          width: 150%;
      }
      ...
      .fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?>:hover .lImgZoom7_<?php echo $Total_Soft_Gallery_Video; ?> {
          width: 150%;
      }
      ...
      .fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?>:hover .hovLayTVG1_<?php echo $Total_Soft_Gallery_Video; ?> {
          opacity: 0.8;
      }
      ...
      .fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?>:hover .hovLayTVG9_<?php echo $Total_Soft_Gallery_Video; ?> {
          left: 0% !important;
          width: 100% !important;
      }
      ...
      .fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?>:hover .hovLayTVG10_<?php echo $Total_Soft_Gallery_Video; ?> {
          top: 0% !important;
          opacity: 0.8 !important;
      }
      ...
      .fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?>:hover .hovLayTVG11_<?php echo $Total_Soft_Gallery_Video; ?> {
          opacity: 0.8 !important;
      }
      ...
      .fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?>:hover .hovTit1_<?php echo $Total_Soft_Gallery_Video; ?> {
          top: 5% !important;
      }
      ...
      .fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?>:hover .hovTit4_<?php echo $Total_Soft_Gallery_Video; ?> {
          top: 5% !important;
      }
      ...
      .fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?>:hover .hovTit7_<?php echo $Total_Soft_Gallery_Video; ?> {
          top: 0% !important;
      }
      ...
      .fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?>:hover .hovLine3_<?php echo $Total_Soft_Gallery_Video; ?> {
          left: 50% !important;
          opacity: 1 !important;
      }
      ...
      .fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?>:hover .hovLine4_<?php echo $Total_Soft_Gallery_Video; ?> {
          width: 80% !important;
          opacity: 1 !important;
      }
      ...
      .fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?>:hover .hovLink3_<?php echo $Total_Soft_Gallery_Video; ?> {
          left: 15% !important;
          opacity: 1 !important;
      }
      ...
      .fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?>:hover .hovLink4_<?php echo $Total_Soft_Gallery_Video; ?> {
          left: 50% !important;
          opacity: 1 !important;
      }
      ...
      .fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?>:hover .hovLink6_<?php echo $Total_Soft_Gallery_Video; ?> {
          left: 50% !important;
          opacity: 1 !important;
      }
      ...
      .fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?>:hover .hovLink7_<?php echo $Total_Soft_Gallery_Video; ?> {
          opacity: 1 !important;
      }
      ...
      .fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?>:hover .hovLink8_<?php echo $Total_Soft_Gallery_Video; ?> {
          opacity: 1 !important;
          top: 60% !important;
      }
      ...
      .totalsoft-gv-lvg-content<?php echo $Total_Soft_Gallery_Video; ?> {
          overflow: hidden;
      }
    ...
    (function($) {
      ...
      $.fn.prettyPhoto=function(pp_settings) {
        pp_settings=jQuery.extend({
          ...
          markup: '<div class="pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>"> \
					     ...
					     <div class="pp_overlay<?php echo $Total_Soft_Gallery_Video; ?>"></div>',
          gallery_markup: '<div class="pp_gallery<?php echo $Total_Soft_Gallery_Video; ?>"> \
          ...
          inline_markup: '<div class="pp_inline<?php echo $Total_Soft_Gallery_Video; ?> clearfix<?php echo $Total_Soft_Gallery_Video; ?>">{content}</div>',
          custom_markup: '',
        ...
        if(pp_settings.keyboard_shortcuts) {
          $(document).unbind('keydown').keydown(function(e) {
            if(typeof $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>!='undefined') {
              if($pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.is(':visible')) {
                switch(e.keyCode) {
                  case 37:
          ...
          $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.fadeIn(function() {
            ...
            switch(_getFileType(pp_images[set_position])) {
              ...
              case'custom':
                ...
                break;
              case'inline':
                myClone=$(pp_images[set_position]).clone().css({'width': settings.default_width}).wrapInner('<div id="pp_full_res<?php echo $Total_Soft_Gallery_Video; ?>"><div class="pp_inline<?php echo $Total_Soft_Gallery_Video; ?> clearfix<?php echo $Total_Soft_Gallery_Video; ?>"></div></div>').appendTo($('body'));
        ...
        $.prettyPhoto.changePage=function(direction) {
          ...
          $('.pp_contract<?php echo $Total_Soft_Gallery_Video; ?>').removeClass('pp_contract<?php echo $Total_Soft_Gallery_Video; ?>').addClass('pp_expand<?php echo $Total_Soft_Gallery_Video; ?>');
        ...
        $.prettyPhoto.changeGalleryPage=function(direction) {
          ...
          $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_gallery<?php echo $Total_Soft_Gallery_Video; ?> li').each(function(i) {
            $(this).animate({'left': (i * itemWidth) - ((itemsToSlide * itemWidth) * currentGalleryPage)});
          });
        };
        $.prettyPhoto.startSlideshow=function() {
          if(typeof pp_slideshow=='undefined') {
            $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_play<?php echo $Total_Soft_Gallery_Video; ?>').unbind('click').removeClass('pp_play<?php echo $Total_Soft_Gallery_Video; ?> <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_20;?>').addClass('pp_pause<?php echo $Total_Soft_Gallery_Video; ?> <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_21;?>').click(function() {
        ...
        $.prettyPhoto.stopSlideshow=function() {
          $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_pause<?php echo $Total_Soft_Gallery_Video; ?>').unbind('click').removeClass('pp_pause<?php echo $Total_Soft_Gallery_Video; ?> <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_21;?>').addClass('pp_play<?php echo $Total_Soft_Gallery_Video; ?> <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_20;?>').click(function() {
        ...
        $.prettyPhoto.close=function() {
          clearInterval(pp_slideshow);
          $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.stop().find('object,embed').css('visibility', 'hidden');
          $('div.pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>,div.ppt<?php echo $Total_Soft_Gallery_Video; ?>,.pp_fade<?php echo $Total_Soft_Gallery_Video; ?>').fadeOut(settings.animation_speed, function() {
            $(this).remove();
          });
          $pp_overlay<?php echo $Total_Soft_Gallery_Video; ?>.fadeOut(settings.animation_speed, function() {
        ...
        _showContent=function() {
          $('.pp_loaderIcon<?php echo $Total_Soft_Gallery_Video; ?>').hide();
          $ppt<?php echo $Total_Soft_Gallery_Video; ?>.fadeTo(settings.animation_speed, 1);
          projectedTop=scroll_pos['scrollTop'] + ((windowHeight / 2) - (correctSizes['containerHeight'] / 2));
          if(projectedTop < 0) projectedTop=0;
          $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_content<?php echo $Total_Soft_Gallery_Video; ?>').animate({'height': correctSizes['contentHeight']}, settings.animation_speed);
          $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.animate({'top': projectedTop, 'left': (windowWidth / 2) - (correctSizes['containeTotalSoftidth'] / 2), 'width': correctSizes['containeTotalSoftidth']}, settings.animation_speed, function() {
            $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_hoverContainer<?php echo $Total_Soft_Gallery_Video; ?>,#fullResImage').height(correctSizes['height']).width(correctSizes['width']);
            $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_fade<?php echo $Total_Soft_Gallery_Video; ?>').fadeIn(settings.animation_speed);
            if(isSet && _getFileType(pp_images[set_position])=="image") {
              $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_hoverContainer<?php echo $Total_Soft_Gallery_Video; ?>').show();
            }
            else {
              $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_hoverContainer<?php echo $Total_Soft_Gallery_Video; ?>').hide();
            }
            if(correctSizes['resized']) $('a.pp_expand<?php echo $Total_Soft_Gallery_Video; ?>,a.pp_contract<?php echo $Total_Soft_Gallery_Video; ?>').fadeIn(settings.animation_speed);
        ...
        function _hideContent(callback) {
          $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('#pp_full_res<?php echo $Total_Soft_Gallery_Video; ?> object,#pp_full_res<?php echo $Total_Soft_Gallery_Video; ?> embed').css('visibility', 'hidden');
          $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_fade<?php echo $Total_Soft_Gallery_Video; ?>').fadeOut(settings.animation_speed, function() {
            $('.pp_loaderIcon<?php echo $Total_Soft_Gallery_Video; ?>').show();
            callback();
          });
        };
        ...
        function _checkPosition(setCount) {
          if(set_position==setCount - 1) {
            $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('a.pp_next').css('visibility', 'hidden');
            $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('a.pp_next').addClass('disabled').unbind('click');
          }
          else {
            $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('a.pp_next').css('visibility', 'visible');
            $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('a.pp_next.disabled').removeClass('disabled').bind('click', function() {
              $.prettyPhoto.changePage('next');
              return false;
            });
          }
          ;
          if(set_position==0) {
            $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('a.pp_previous').css('visibility', 'hidden').addClass('disabled').unbind('click');
          }
          else {
            $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('a.pp_previous.disabled').css('visibility', 'visible').removeClass('disabled').bind('click', function() {
              $.prettyPhoto.changePage('previous');
              return false;
            });
          }
          ;(setCount > 1) ? $('.pp_nav<?php echo $Total_Soft_Gallery_Video; ?>').show() : $('.pp_nav<?php echo $Total_Soft_Gallery_Video; ?>').hide();
        };
        ...
        function _getDimensions(width, height) {
          ...
          $pp_details<?php echo $Total_Soft_Gallery_Video; ?>=$pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_details<?php echo $Total_Soft_Gallery_Video; ?>');/*----poxel---*/
          $pp_details<?php echo $Total_Soft_Gallery_Video; ?>.width();
          detailsHeight=parseFloat($pp_details<?php echo $Total_Soft_Gallery_Video; ?>.css('marginTop')) + parseFloat($pp_details<?php echo $Total_Soft_Gallery_Video; ?>.css('marginBottom'));
          $pp_details<?php echo $Total_Soft_Gallery_Video; ?>=$pp_details<?php echo $Total_Soft_Gallery_Video; ?>.clone().appendTo($('body')).css({'position': 'absolute', 'top': -10000});
          detailsHeight+=$pp_details<?php echo $Total_Soft_Gallery_Video; ?>.height();
          detailsHeight=(detailsHeight <= 34) ? 36 : detailsHeight;
          if(navigator.userAgent.match(/msie [6]/i) && !window.XMLHttpRequestmsie && $.browser.version==7) detailsHeight+=8;
          $pp_details<?php echo $Total_Soft_Gallery_Video; ?>.remove();
          pp_contentHeight=height + detailsHeight;
          pp_contentWidth=width;
          pp_containerHeight=pp_contentHeight + $ppt<?php echo $Total_Soft_Gallery_Video; ?>.height() + $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_top<?php echo $Total_Soft_Gallery_Video; ?>').height() + $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_bottom<?php echo $Total_Soft_Gallery_Video; ?>').height();
        ...
        function _center_overlay() {
          if(doresize && typeof $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>!='undefined') {
            scroll_pos=_get_scroll();
            titleHeight=$ppt<?php echo $Total_Soft_Gallery_Video; ?>.height(), contentHeight=$pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.height(), contentwidth=$pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.width();
            projectedTop=(windowHeight / 2) + scroll_pos['scrollTop'] - (contentHeight / 2);
           
               $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.css({'top': '20%', 'left': Math.floor((windowWidth / 2)) + scroll_pos['scrollLeft'] - Math.floor((contentwidth / 2))});
          }
          ;
        };
        ...
        function _resize_overlay() {
          ...
          if(typeof $pp_overlay<?php echo $Total_Soft_Gallery_Video; ?>!="undefined") $pp_overlay<?php echo $Total_Soft_Gallery_Video; ?>.height($(document).height());
        };
        ...
        function _insert_gallery() {
          if(isSet && settings.overlay_gallery && _getFileType(pp_images[set_position])=="image") {
            ...
            if(totalPage==0) {
              navWidth=0;
              $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_gallery<?php echo $Total_Soft_Gallery_Video; ?> .pp_arrow_next<?php echo $Total_Soft_Gallery_Video; ?>,.pp_gallery<?php echo $Total_Soft_Gallery_Video; ?> .pp_arrow_previous<?php echo $Total_Soft_Gallery_Video; ?>').hide();
            }
            else {
              $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_gallery<?php echo $Total_Soft_Gallery_Video; ?> .pp_arrow_next<?php echo $Total_Soft_Gallery_Video; ?>,.pp_gallery<?php echo $Total_Soft_Gallery_Video; ?> .pp_arrow_previous<?php echo $Total_Soft_Gallery_Video; ?>').show();
            }
            ;galleryWidth=itemsPerPage * itemWidth + navWidth;
            $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_gallery<?php echo $Total_Soft_Gallery_Video; ?>').width(galleryWidth).css('margin-left', -Math.floor((galleryWidth / 2)));
            $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_gallery<?php echo $Total_Soft_Gallery_Video; ?> ul').width(itemsPerPage * itemWidth).find('li.selected').removeClass('selected');
            goToPage=(Math.floor(set_position / itemsPerPage) <= totalPage) ? Math.floor(set_position / itemsPerPage) : totalPage;
            if(itemsPerPage) {
              $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_gallery<?php echo $Total_Soft_Gallery_Video; ?>').hide().show().removeClass('disabled');
            }
            else {
              $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_gallery<?php echo $Total_Soft_Gallery_Video; ?>').hide().addClass('disabled');
            }
            $.prettyPhoto.changeGalleryPage(goToPage);
            $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_gallery<?php echo $Total_Soft_Gallery_Video; ?> ul li:eq(' + set_position + ')').addClass('selected');
          }
          else {
            $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_content<?php echo $Total_Soft_Gallery_Video; ?>').unbind('mouseenter mouseleave');
            $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_gallery<?php echo $Total_Soft_Gallery_Video; ?>').hide();
          }
        }
        ...
        function _buildOverlay(caller) {
          ...
          $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>=$('.pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>'), $ppt<?php echo $Total_Soft_Gallery_Video; ?>=$('.ppt<?php echo $Total_Soft_Gallery_Video; ?>'), $pp_overlay<?php echo $Total_Soft_Gallery_Video; ?>=$('div.pp_overlay<?php echo $Total_Soft_Gallery_Video; ?>');
          if(isSet && settings.overlay_gallery) {
            ...
            $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('#pp_full_res<?php echo $Total_Soft_Gallery_Video; ?>').after(toInject);
            $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_gallery<?php echo $Total_Soft_Gallery_Video; ?> .pp_arrow_next<?php echo $Total_Soft_Gallery_Video; ?>').click(function() {
              $.prettyPhoto.changeGalleryPage('next');
              $.prettyPhoto.stopSlideshow();
              return false;
            });
            $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_gallery<?php echo $Total_Soft_Gallery_Video; ?> .pp_arrow_previous<?php echo $Total_Soft_Gallery_Video; ?>').click(function() {
              $.prettyPhoto.changeGalleryPage('previous');
              $.prettyPhoto.stopSlideshow();
              return false;
            });
            $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_content<?php echo $Total_Soft_Gallery_Video; ?>').hover(function() {
              $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_gallery<?php echo $Total_Soft_Gallery_Video; ?>:not(.disabled)').fadeIn();
            }, function() {
              $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_gallery<?php echo $Total_Soft_Gallery_Video; ?>:not(.disabled)').fadeOut();
            });
            itemWidth=52 + 5;
            $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_gallery<?php echo $Total_Soft_Gallery_Video; ?> ul li').each(function(i) {
          ...
          if(settings.slideshow) {
            $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_nav<?php echo $Total_Soft_Gallery_Video; ?>').prepend('<i class="totalsoft-gv-lvg-pl-pa<?php echo $Total_Soft_Gallery_Video; ?> pp_play<?php echo $Total_Soft_Gallery_Video; ?> <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_20;?>"></i>')
            $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_nav<?php echo $Total_Soft_Gallery_Video; ?> .pp_play<?php echo $Total_Soft_Gallery_Video; ?>').click(function() {
              $.prettyPhoto.startSlideshow();
              return false;
            });
          }
          $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.attr('class', 'pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?> ' + settings.theme);
          $pp_overlay<?php echo $Total_Soft_Gallery_Video; ?>.css({'opacity': 0, 'height': $(document).height(), 'width': $(document).width()}).bind('click', function() {
            if(!settings.modal) $.prettyPhoto.close();
          });
          $('i.pp_close<?php echo $Total_Soft_Gallery_Video; ?>').bind('click', function() {
            $.prettyPhoto.close();
            return false;
          });
          $('a.pp_expand<?php echo $Total_Soft_Gallery_Video; ?>').bind('click', function(e) {
            if($(this).hasClass('pp_expand<?php echo $Total_Soft_Gallery_Video; ?>')) {
              $(this).removeClass('pp_expand<?php echo $Total_Soft_Gallery_Video; ?>').addClass('pp_contract<?php echo $Total_Soft_Gallery_Video; ?>');
              doresize=false;
            }
            else {
              $(this).removeClass('pp_contract<?php echo $Total_Soft_Gallery_Video; ?>').addClass('pp_expand<?php echo $Total_Soft_Gallery_Video; ?>');
              doresize=true;
            }
            ;_hideContent(function() {
              $.prettyPhoto.open();
          ...
          $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_previous, .pp_nav<?php echo $Total_Soft_Gallery_Video; ?> .pp_arrow_previous<?php echo $Total_Soft_Gallery_Video; ?>').bind('click', function() {
            $.prettyPhoto.changePage('previous');
            $.prettyPhoto.stopSlideshow();
            return false;
          });
          $pp_pic_holder<?php echo $Total_Soft_Gallery_Video; ?>.find('.pp_next, .pp_nav<?php echo $Total_Soft_Gallery_Video; ?> .pp_arrow_next<?php echo $Total_Soft_Gallery_Video; ?>').bind('click', function() {
            $.prettyPhoto.changePage('next');
            $.prettyPhoto.stopSlideshow();
            return false;
          });
  ...
  <div class="Tot_GL<?php echo $Total_Soft_Gallery_Video; ?> Tot_GL" style="position: relative;">
    ...
    <div class="totalsoft-gv-lvg-content<?php echo $Total_Soft_Gallery_Video; ?>">
      <ul class="ulContWidth totalsoft-gv-lvg-area<?php echo $Total_Soft_Gallery_Video; ?>" style='padding:0px; display: none;'>
							<?php for($i=0;$i<count($Total_Soft_GalleryV_Videos);$i ++){ ?>
								<?php if(str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL)==''){
									$TS_GV_LVG_VSR=str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL);
								}
								else{
									/*---poxel----*/
									$TS_GV_LVG_VSR  =str_replace('Tsyou_','https://www.youtube.com/watch?v=',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_Video);
									$TS_GV_LVG_VSRST=str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL);
									$TS_GV_LVG_VSRST; /*---*/
								} ?>
								<?php if($Total_Soft_GalleryV_Man[0]->TotalSoftGallery_Video_ShowType=='All'){ ?>
           <li class="totalsoft-gv-lvg-item2 TotalSoft_GV_LVG_Li" id="TotalSoft_GV_LVG_<?php echo $Total_Soft_Gallery_Video; ?>_<?php echo $i + 1; ?>" style='max-width:100%;'>
             <div class='fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?> fHeightZoom2'>
											<span class="totalsoft-gv-lvg-image-block<?php echo $Total_Soft_Gallery_Video; ?>">
												<a class="image-zoom" href="<?php echo $TS_GV_LVG_VSRST; ?>" rel="prettyPhoto[gallery_<?php echo $Total_Soft_Gallery_Video; ?>]" title="<?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_14=='true'){
																									echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT);
																								} ?>">
													<?php
																										$url=str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL);
																										if(strpos($url,'http')!==false){
													...
													<?php if($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VLink!=''){ ?>
                            <a href='<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VLink ?>' class='hovLink <?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_33; ?>_<?php echo $Total_Soft_Gallery_Video; ?>' <?php if($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VONT=='true'){
																													echo 'target="_blank"';
																												} ?>>
               ...
               <div class='fHeightZoom<?php echo $Total_Soft_Gallery_Video; ?> fHeightZoom2'>
													<span class="totalsoft-gv-lvg-image-block<?php echo $Total_Soft_Gallery_Video; ?>">
														<a class="image-zoom" href="<?php echo $TS_GV_LVG_VSRST; ?>" rel="prettyPhoto[gallery_<?php echo $Total_Soft_Gallery_Video; ?>]" title="<?php if($TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_14=='true'){
															...
															<img class='LImg <?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_10; ?>_<?php echo $Total_Soft_Gallery_Video; ?>' src="<?php echo str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL); ?>" alt="<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>" title="<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>"/>
															<div class='<?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_13; ?>_<?php echo $Total_Soft_Gallery_Video; ?>'></div>
															<h2 class='<?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_20; ?>_<?php echo $Total_Soft_Gallery_Video; ?>'>
																<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>
															</h2>
